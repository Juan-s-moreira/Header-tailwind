  ...
  return (
    <div className='isolate'>
      ...
      <div className='container mx-auto px-6 py-20 md:py-24 lg:py-28 xl:py-32'>
        <div className='flex flex-col lg:flex-row items-center gap-8 lg:gap-12 xl:gap-60'>
          <div className='flex-1 space-y-6 lg:space-y-7'>
            <div className='space-y-4 lg:space-y-5'>
              <div className='flex items-center'>
                ...
                <h2 className='inline-block px-3 py-1.5 lg:px-4 lg:py-2 rounded-full bg-neutral-900 text-amber-400 font-medium text-sm backfrop-blur-sm border border-neutral-800/50%'>
                  <i className='bx bx-trending-up mr-1'> Next Generation design System</i></h2>
              </div>
              ...
              <div className='flex flex-col sm:flex-row gap-5 sm:items-center pt-6 lg:pt-7 border-t border-neutral-200 dark:border-neutral-800'>
                ...
                <div className='space-y-1 '>
                  ...
                  <p className='text-neutral-600 dark:text-neutral-400 text-sm'>Trusted by <span className='font-bold text-neutral-900 dark:text-white'>5,000+</span> developers worldwide</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className='relative'>
              ...
              <div className='relative bg-white dark:bg-neutral-900 p-4 lg:p-5 xl:p-6 rounded-2xl shadow-2xl border border-neutral-200 dark:border-neutral-800'>
                ...
                <div className='h-56 md:h-64 lg:h-60 xl:h-72 rounded-lg bg-neutral-100 dark:bg-neutral-800 overflow-hidden relative'>
                  <img src="\images\code-light.png" alt="Code snippet for light mode" className='w-full h-full object-cover object-left-top dark:hidden' />
                  <img src="\images\code-dark.png" alt="Code snippet for dark mode" className='w-full h-full object-cover object-left-top dark:block' />
      ...
      <div className='hidden md:block absolute top-16 right-[15%] lg:top-20 lg:right-[20%] animate-bounce delay-300'>
        <div className='bg-neutral-900 text-white px-2.5 py-1.5 rounded-lg text-xm lg:text-sm flex items-center shadow-lg'>
          <i className='bx bx-check-circle mr-1 text-amber-500' ></i> Acessible
        </div>
      </div>
    </div>
  )
